...
import { JS_TYPES, INVOICE_STATUS, PAYMENT_METHOD_TYPE, ENTITY_TYPE, ACTIVITY_ACTION } from '../config/constants.js';
    ...
    try {
        ...
        if (PLAN_PRICES[requestedPlan] > 0) {
            await Invoice.create({
                ...
                paymentMethod: { type: PAYMENT_METHOD_TYPE.CARD, last4: '4242', brand: 'Visa' },
            });
        }
        ...
        await ActivityLog.create({
            ...
            tenant: req.tenantId,
            action: ACTIVITY_ACTION.BILLING_CHANGE_PLAN,
            entityType: ENTITY_TYPE.BILLING,
